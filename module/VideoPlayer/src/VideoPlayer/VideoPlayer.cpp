...
//            out_sample_rate = 44100;
            out_sample_rate = aCodecCtx->sample_rate;// 默认与输入采样率相同，也可以强制为44100Hz
            ...
            //存储pcm数据
            int out_linesize = out_sample_rate * audio_tgt_channels;//多余的
...
int VideoPlayer::openAudio() {
    ...
    audioOutput->setBufferSize(768000);  // 增大缓冲区
